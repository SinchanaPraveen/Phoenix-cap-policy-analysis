...
class Settings:
    ...
    claude_model: str = field(
        default_factory=lambda: os.getenv("CLAUDE_MODEL", "claude-3-haiku-20240307")
    )
    ...
    # ------------------------------------------------------------------
    max_tokens_stage1: int = 1200
    max_tokens_stage2: int = 1200
    max_tokens_stage3: int = 1800
    max_tokens_stage4: int = 1800
    max_tokens_stage5: int = 600 #working
